    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={{ flex: 1, paddingHorizontal: 35, }}>
        ...
        <View style={{ marginVertical: 40, justifyContent: 'space-between' }}>
          <CustomText style={styles.title_filed} title={'تسجيل دخول كمزود خدمه'} />
          <CustomTextInput placeholder={'الاسم'} style={styles.login_fields} />
          <CustomTextInput placeholder={'البريد الالكتروني'} keyboardType="email-address" style={styles.login_fields} />
          <CustomTextInput placeholder={'رقم الهاتف'} keyboardType='number-pad' style={styles.login_fields} />
          <CustomTextInput placeholder={'كلمه السر'} secureTextEntry={true} style={styles.login_fields} />
          <CustomTextInput placeholder={'اسم الصالون'} style={styles.login_fields} />
          <CustomTextInput placeholder={'عنوان الصالون'} style={styles.login_fields} />
          <View style={{ flex: 1, justifyContent: 'space-between' }}>
            <CustomText title={'شعار الصالون'} style={{ fontFamily: FONTFAMILY.cairoBold, marginBottom: 5 }} />
          ...
          <TouchableOpacity style={styles.sign_button} onPress={() => { navigation.navigate("Main"); }}>
            <CustomText style={{ color: Colors.white }} title={'تسجيل'} />
          </TouchableOpacity>
        </View>
        <View style={{ marginBottom: 25, justifyContent: 'space-between' }}>
          <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
            <CustomText title={'هل تمتلك حساب ؟'} />
            <TouchableOpacity  onPress={() => {navigation.navigate("Login");}}>
              <CustomText style={styles.login_buttton} title={'تسجيل دخول'} />
            </TouchableOpacity>
          </View>
        </View>
        <Modal
          ...
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              <TouchableOpacity onPress={() => openCamera()} style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                <CustomText title={'كاميرا'} style={{ fontFamily: FONTFAMILY.cairoBold }} />
              ...
              <TouchableOpacity onPress={() => showImagePicker()} style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 10 }}>
                <CustomText title={'الصور'} style={{ fontFamily: FONTFAMILY.cairoBold }} />
